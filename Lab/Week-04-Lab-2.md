...
2. **คำถามนำเพื่อการวิเคราะห์เชิงระบบ (Critical Thinking):**
   ...
   ตอบ  แนวโน้มสัญญาณ: ค่าดิบของ ADC มีลักษณะการลดลงแบบ Exponential Decay (การคายประจุแบบเลขชี้กำลัง) โดยแซมเปิ้ลที่ 1 จะมีค่าสูงที่สุดเนื่องจากเป็นช่วงที่ไฟ TX เพิ่งดับลง ประจุที่เกิดจาก Photovoltaic Effect บน LED ภาครับยังคงค้างอยู่ จากนั้นค่าสัญญาณจะไต่ระดับลดลงอย่างรวดเร็วในช่วงแซมเปิ้ลที่ 1–7 และค่อยๆ ลดลงช้าลงจนคงที่ราบเรียบในสภาวะ Steady State ตั้งแต่แซมเปิ้ลที่ 10 เป็นต้นไป

    - สัญญาณไฟฟ้าเข้าสู่ความนิ่ง (Settling) ที่แซมเปิ้ลใด หรือใช้เวลากี่มิลลิวินาที?
      1.35 วินาที โดยใช้สูตร  Settling Time = Sample Context - 1) x Sampling Delay
...
การกำหนดช่วงข้ามสัญญาณ (Blanking Window / Discarding Transient): เขียนโปรแกรมให้ข้ามการบันทึกข้อมูลในช่วงแรก ($0 - 1,350\text{ ms}$) หรือละเว้นการนำแซมเปิ้ลที่ 1 ถึง 9 มาคำนวณ
การคัดเลือกเฉพาะสภาวะคงตัว (Steady-State Sampling): นำเฉพาะข้อมูลจาก แซมเปิ้ลที่ 10 ถึง 20 มาเข้าสูตรหาค่าเฉลี่ย (Mean) หรือใช้อัลกอริทึมมัธยฐาน (Median Filter) เพื่อกรอง Impulse Noise ที่อาจเกิดขึ้นในระบบ
